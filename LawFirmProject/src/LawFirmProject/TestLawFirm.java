		...
		do {
           ...
           while(true){
             ...
             break;
               ...
               catch (NotRequiredInputException e) {   
            ...
            while(true){
             ...
             if (LawyerLicenseStatus != 'A' && LawyerLicenseStatus != 'S' && LawyerLicenseStatus != 'R') {
                    throw new NotRequiredInputException("Invalid Lawyer’s License Status. Please enter A, S, or R.");
             }
				...
				int choice2 ;
                           ...
                           while(true){
                            ...
                            if (LawyerNewLicenseStatus != 'A' && LawyerNewLicenseStatus != 'S' && LawyerNewLicenseStatus != 'R') {
                                   throw new NotRequiredInputException("Invalid experience level. Please enter A, S, or R.");
                            }
			...
			case 6: 
               ...
               while(true){
                ...
                if (CaseStatus != 'A' && CaseStatus != 'P' && CaseStatus != 'L' && CaseStatus != 'W') {
                       throw new NotRequiredInputException("Invalid  Case Status. Please enter A, P, L or W.");
                }
               ...
               while(true){
                 ...
                 if (CaseType != 1 && CaseType != 2) {
                     throw new NotRequiredInputException("Invalid case type. Please enter 1 for Criminal Case or 2 for Civil Case.");
                 }
               break;
               }catch(InputMismatchException e){ 
                input.next(); 
                 ...
                 System.out.println(e.getMessage());
                   ...
                   while(true){
                      ...
                      if (CrimeType != 'C' && CrimeType != 'M' && CrimeType != 'R' && CrimeType != 'H') {
                             throw new NotRequiredInputException("Invalid Crime Type. Please enter C, M, R ,or H.");
                      }
                  ...
                  System.out.println("Enter Civil Type ( Family Law (F), Property Law (P), Contract Law (C) ) : ");
                    while(true){
                      ...
                      if (CivilType != 'F' && CivilType != 'P' && CivilType != 'C') {
                             throw new NotRequiredInputException("Invalid Civil Type. Please enter F, P, or C.");
                      }
			...
			case 10: 
                ...
                while(true){
                   ...
                   if (DocumentType != 'B' && DocumentType != 'C' && DocumentType != 'T' && DocumentType != 'E') {
                          throw new NotRequiredInputException("Invalid Document’s Type. Please enter B, C, T, or E.");
                   }
                 ...
                 while(true){
                   ...
                   if (DocumentAccessLevel != 'P' && DocumentAccessLevel != 'C' && DocumentAccessLevel != 'R') {
                          throw new NotRequiredInputException("Invalid Document’s Access Level. Please enter J, S, or P.");
                   }
                  ...
                  choice4 = -1; // Set choice to an invalid value to loop again
                      ...
                      while(true){
                         ...
                         if (NewType != 'B' && NewType != 'C' && NewType != 'T' && NewType != 'E') {
                                throw new NotRequiredInputException("Invalid Type. Please enter B, C, T, or E.");
                         }
                       ...
                       while(true){
                         ...
                         if (NewAccessLevel != 'P' && NewAccessLevel != 'C' && NewAccessLevel != 'R') {
                                throw new NotRequiredInputException("Invalid  Access Level. Please enter P, C, or R.");
                         }
