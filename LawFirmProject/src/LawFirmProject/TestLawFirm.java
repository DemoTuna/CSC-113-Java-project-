...
String lawFirmName = JOptionPane.showInputDialog(null, "Enter Law Firm Name :" , "Law Firm Name", JOptionPane.INFORMATION_MESSAGE ) ;
String LawFirmLocation = JOptionPane.showInputDialog(null, "Enter Law Firm Location : " , "Location", JOptionPane.INFORMATION_MESSAGE ) ;
String LawFirmYearFounded = JOptionPane.showInputDialog(null, "Enter The Year The Law Firm Was Founded :" , "Year Founded", JOptionPane.INFORMATION_MESSAGE ) ;
String LawFirmOwnerName = JOptionPane.showInputDialog(null, "Enter Law Firm Owner Name : " , "owner Name", JOptionPane.INFORMATION_MESSAGE ) ;
String LawFirmSize = JOptionPane.showInputDialog( "Enter The Maximm Number Of Lawyers: " , "0" ) ;
int size = Integer.parseInt(LawFirmSize) ;
LawFirm LawFirm1 = new LawFirm( lawFirmName, LawFirmLocation , LawFirmYearFounded ,  LawFirmOwnerName , size );
JOptionPane.showMessageDialog (null, "Law Firm Name : " + lawFirmName + "\nlocation :" + LawFirmLocation + "\nyear Founded: " + LawFirmYearFounded + "\nLaw Firm Owner Name: " + LawFirmOwnerName + "\nThe Maximm Number Of Lawyers:" +  LawFirmSize) ;
break;
}		
catch (NumberFormatException ex) {
JOptionPane.showMessageDialog (null, "Error, only number please ");
		} }*/
               
             MainJframe f1 = new MainJframe();
               f1.setVisible(true);
